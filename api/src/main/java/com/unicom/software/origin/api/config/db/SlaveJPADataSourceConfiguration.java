...
public class SlaveJPADataSourceConfiguration extends JpaBaseDataSourceConfiguration {
    ...
    public final static String REPOSITORY_BASE_PACKAGES = "com.unicom.software.origin.db." + SPECIAL_NAME + ".mapper";
    public final static String ENTITY_BASE_PACKAGES = "com.unicom.software.origin.db." + SPECIAL_NAME + ".model";
